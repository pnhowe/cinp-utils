...
{% for action in actions %}
    def {{ action.name }}( self{% for parameter in action.parameters %}, {{ parameter.name }}{% endfor %} ):
{% if action.static %}
      return ---cinp.call( {{ action.url }}{% for parameter in action.parameters %}, {{ parameter.name }}{% endfor %} )
{% else %}
      return cinp.call( {{ action.url }}{% for parameter in action.parameters %}, {{ parameter.name }}{% endfor %} )
{% endif %}
{% endfor %}
